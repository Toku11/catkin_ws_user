...
motor_communication::motor_communication(): priv_nh_("~"), my_serial("/dev/ttyUSB2",9600, serial::Timeout::simpleTimeout(2))
{
  result="";
...
double motor_communication::getSpeed()
{
    ...
    //my_serial.flush();
		...
		result = my_serial.readline(); // -12.000 to 12.000 rpm inital config.
