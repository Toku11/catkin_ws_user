...
class color_controller():
	def __init__(self, publish_tf):
		...
		rospy.Subscriber("camera_topic", CameraInfo, self.camera_callback,queue_size=1)
		...
		rospy.Subscriber('blobs', Blobs, self.blob_callback,queue_size=1)
		...
		self.blob_pub = rospy.Publisher('/blobs_3d', Blobs3d,queue_size=1)
